...
//Pantalla informativa que explica qué son las expresiones regulares y muestra un ejemplo práctico.
export const InfoScreen: React.FC = () => {
  const navigation = useNavigation<NativeStackNavigationProp<RootStackParamList>>(); // Configuración de navegación con tipado seguro

  const ejemplo = '\\b\\d{3}-\\d{2}-\\d{4}\\b'; // Ejemplo de expresión regular para números de seguro social
